...
(function (global, factory) {
    ...
    var _hoisted_1$4 = /*#__PURE__*/vue.createElementVNode("img", { src: img$1 }, null, -1);
    var _hoisted_2$2 = [
      _hoisted_1$4
    ];
    ...
    var _hoisted_1$3 = ["checked", "value"];
    var _hoisted_2$1 = ["aria-checked", "aria-disabled", "aria-readonly", "tabindex"];
    ...
    var _hoisted_1$1 = { class: "flex row bs-slider no-wrap" };
    var _hoisted_2 = ["value", "min", "max", "step"];
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return (vue.openBlock(), vue.createElementBlock("div", {
        ...
        (($props.hint && _ctx.$attrs.label))
          ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, vue.toDisplayString($props.hint), 1))
          : vue.createCommentVNode("", true)
      ], 2))
    }
