...
import { DSSDatasetData, DSSDatasetSchema, DSSDatasetGenericData, RangeFilter } from "./backend_model";
export default class ServerApi {
    ...
    static getFilteredDataset(datasetName: string, chunksize: number, chunk_index: number, filters?: Record<string, string[] | RangeFilter>): Promise<any>;
