...
export default class ServerApi {
    ...
    static getFilteredDataset(datasetName: string, chunksize?: number, chunk_index?: number, filters?: Record<string, any[]>, group_key?: string, group_rows?: string): Promise<any>;
