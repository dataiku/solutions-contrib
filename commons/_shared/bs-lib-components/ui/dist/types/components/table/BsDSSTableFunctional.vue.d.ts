...
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    fetchFilteredDSSDataset(datasetName: string, chunksize?: number | undefined, chunk_index?: number | undefined, filters?: Record<string, any[]> | undefined, group_key?: string | undefined, group_rows?: string | undefined): Promise<Record<string, any>[] | undefined>;
    fetchDSSColumns(datasetName: string): Promise<{
        columns: BsTableCol[];
        columnsCount: number;
    }>;
    updateColumns(datasetName: string): void;
    updateRows(datasetName: string, chunksize?: number | undefined, chunk_index?: number | undefined, filters?: Record<string, any[]> | undefined, group_key?: string | undefined, group_rows?: string | undefined): void;
