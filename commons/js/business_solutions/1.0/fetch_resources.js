 ...
 **/
 class BSStaticResources {
    ...
    constructor() {
      this.loaded = new Set();
      this.fetch_scripts = [
        "/fetch/commons/js/echarts/5.3.2/echarts.js",
    ...
    addScripts(my_scripts) {
      for (const my_script of my_scripts) {
        if (this.fetch_scripts.includes(my_script)) {
          console.log(
            "BSStaticResources: [" + my_script + "] already registered"
          );
        } else {
  ...
  dku_bs_resources.addScripts([
    "/fetch/commons/js/echarts/5.3.2/echarts.js",
    "/fetch/commons/js/vue/3.2.33/vue.global.js",
    "/fetch/commons/js/bootstrap/5.1.3/bootstrap.bundle.min.js",
  ]);
  
  dku_bs_resources.addLinks([
    "/fetch/commons/css/bootstrap/5.1.3/bootstrap.min.css",
  ]);
  ...
  dku_bs_resources
    .load_resources()
    .then(console.log(" Business solutions resources loaded "));
